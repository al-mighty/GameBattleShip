...
class GameBattleShip extends JFrame {
    ...
    final String TITLE_OF_HUMAN_FIELD = "мои кораблики";
    final String TITLE_OF_AI_FIELD = "Робота корабли";
    final String BTN_NEW_GAME = "Новая игра";
    final String BTN_SHOW_MY = "Показать " + TITLE_OF_HUMAN_FIELD;
    final String BTN_SHOW_ENEMY = "Показать " + TITLE_OF_AI_FIELD;
    final String BTN_EXIT_GAME = "Выйти из игры";
    final String YOU_WON = "Ты победил!";
    final String AI_WON = "Робот победил!";
